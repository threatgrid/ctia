...
| ctia.store.es.[entity].auth.params.password    | :password param for :basic-auth auth method to ES, see [[https://github.com/threatgrid/ductile][ductile documentation]] | string |
