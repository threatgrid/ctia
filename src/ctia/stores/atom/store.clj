...
(defrecord PackageStore [state]
  IPackageStore
  (read-package [_ id]
    (package/handle-read-package state id))
  (create-package [_ new-package]
    (package/handle-create-package state new-package))
  (delete-package [_ id]
    (package/handle-delete-package state id)))
