...
(tk/defservice events-service
  ...
  (central-channel [this] (core/get-central-channel (service-context this)))
  ...
  (register-listener
    [this listen-fn mode] (core/register-listener
                            (service-context this)
                            listen-fn mode))
  (register-listener
    [this pred listen-fn mode] (core/register-listener
                                 (service-context this)
                                 pred listen-fn mode)))
